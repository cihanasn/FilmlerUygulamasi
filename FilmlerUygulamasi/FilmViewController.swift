...
class FilmViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let f1 = Filmler(film_id: 1, film_ad: "Django", film_yil: 2012, film_resim: "django", kategori: nil, yonetmen: nil)
        
        let f2 = Filmler(film_id: 1, film_ad: "Inception", film_yil: 2012, film_resim: "inception", kategori: nil, yonetmen: nil)
